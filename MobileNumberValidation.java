...
public class MobileNumberValidation {
		...
		/**
		 * @purpose : Check the validation of Mobile Number
		 * @return : No return Value 
		 */
		
		public static void checkValidMobileNumber(String mobNumber) 
		{
			...
			if (isMobileNumber)
				System.out.println(mobNumber + " is an Valid Mobile Number \n");
			else
				System.out.println(mobNumber + " is an Invalid Mobile Number");
